    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          'rounded-2xl border border-white/10 bg-surface p-6 shadow-card',
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 rounded-md p-1.5 text-text-subtle hover:bg-white/10 hover:text-text-primary"
          aria-label="Close"
        >
          <X size={16} />
        </DialogPrimitive.Close>
